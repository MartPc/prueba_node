...
const listarDatos= async()=>{
    ...
    .then(function(data){
        ...
        return listaCompras.map(function(compra){
            ...
            `<td>${compra.estado}</td>`+
            `<td><button type="button" class="btn btn-primary"  data-bs-toggle="modal"  data-bs-target="#exampleModal" onclick='editar(${JSON.stringify(compra)})'>Editar</button></td>
            <td><a href='#'  class="btn btn-danger" onclick='eliminar(${JSON.stringify(compra)})' type="button">Eliminar</a></td>
            <td><a href='#'  class="btn btn-primary")' type="button">Ver detalle</a></td></tr>`
